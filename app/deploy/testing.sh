...
# python3 precompute.py dataset/ind/product_i_2000_7.csv dataset/ind/customer_i_2000_7.csv 1
# python3 precompute.py dataset/ind/product_i_2000_7.csv dataset/ind/customer_i_2000_7.csv 2
# python3 precompute.py dataset/ind/product_i_2000_7.csv dataset/ind/customer_i_2000_7.csv 3

# echo "2000 7 done"

# echo "TESTING ANTI-CORRELATED"

# python3 precompute.py dataset/ant/product_ac_2000_6.csv dataset/ant/customer_ac_2000_6.csv 1
# python3 precompute.py dataset/ant/product_ac_2000_6.csv dataset/ant/customer_ac_2000_6.csv 2
# python3 precompute.py dataset/ant/product_ac_2000_6.csv dataset/ant/customer_ac_2000_6.csv 3
