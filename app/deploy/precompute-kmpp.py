import csv, sys, os
from customer_thread import CustThread
from pandora_box_kmpp import PandoraBox
from event_queue import EventQueue
from logger import Logger
from precompute import make_session
...
def kmpp_precompute(product_dataset, customer_product):
  ...
  pandora_path = 'session/' + dataset[0]
...
if __name__ == "__main__":
  ...
  kmpp_precompute(dataset[0], dataset[1])